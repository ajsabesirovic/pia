...
@section('title', 'Novi dobavljac')

@section('content')
<div class="pb-2 mb-3 border-bottom">
    <h1 class="h2">Novi dobavljac</h1>
</div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('pib') is-invalid @enderror" name="pib" value="{{ old('pib') }}" required>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="aktivan" value="1" id="aktivan" {{ old('aktivan', true) ? 'checked' : '' }}>
